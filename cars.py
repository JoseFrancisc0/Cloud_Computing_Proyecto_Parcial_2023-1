...
def create_car():
    ...
    car = Car(brand = data['brand'], model = data['model'], type_of_car = data['type_of_car'], year_car = data['year_car'], cost_per_day = data['cost_per_day'])
    db.session.add(car)
    db.session.commit()
...
def get_cars():
    ...
    return jsonify([{'id' : car.id,
                        ...
                        'cost_per_day' : car.cost_per_day} for car in cars]), 200
...
def get_car(id):
    ...
    return jsonify({'id' : car.id,
                        ...
                        'type_of_car' : car.type_of_car,
                        'year_car' : car.year_car,
                        'cost_per_day' : car.cost_per_day}), 200
